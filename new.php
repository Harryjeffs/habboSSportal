...
<?php include('inc/top-banner.php');?>
                          ...
                          <div class="container" style="margin-top: 100px;">
                              ...
                              <ol class="breadcrumb">
                                  <li>
                                      <a href="<? echo FULL_PATH ?>/index.php">Forum Home</a>
                                  </li>
                                  <li>
                                      <a href="<? echo FULL_PATH?>/category/<?php echo $sub_category_id; ?>"><?php echo $stuff['sub_category_desc']; ?></a>
                                  </li>
                                  <li class="active">Create Thread</li>
                              </ol>
                              <?php
                              if($disabled->num_rows > 0 and $disable->disable_type == 3 or $disable->disable_type == 5){
                                  if($disable->disable_type == 3 or $disable->disable_type == 5){
                                      echo "<div class='alert alert-info'>
                                               <b> Your thread creation privileges have been temporarily disabled by an administrator.</b>
                                             </div>";
                                  }
                              }else{
                              ?>
                              <form id="formid" action="" title="" method="post" novalidate>
                                  <div class="panel panel-default">
                                      <div class="panel-heading"
                                           style="padding: 0px; padding-left: 5px; padding-right: 5px; background: #fafafa;">
                                          <div class="row">
                                              <div class="col-xs-8">
                                                  <input aria-describedby="basic-addon3" name="threadTitle"
                                                         class="form-control removeShadowInput" id="threadTitle"
                                                         placeholder="Title of thread"
                                                         style="border: none; background: #fafafa; margin-top: 4px; font-size: 16px;"
                                                         type="text">
                                              </div>
                                              <div class="col-xs-4">
                                                  <label class="checkbox">
                                                      <input style="height: 20px; width: 20px" type="checkbox"> <span
                                                          class="control-indicator"></span> <span
                                                          class="controller-text">Pin Thread</span></label>
                                              </div>
                                          </div>
                                      </div>
                                      <div class="panel-body" style="padding: 0 !important;">
                                          <input type="hidden" name="threadID" id="subCat"
                                                 value="<?php echo $sub_category_id ?>">
                                          <textarea id="threadContents" name="threadContents" rows="6"></textarea>
                                          <button type="submit" class="btn btn-success btn-block" name="threadBtn"
                                                  style="border-radius: 0px; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px">
                                              Publish
                                          </button>
                              ...
                              <div class="alert alert-info">
                                  All threads and posts which do not comply with our forum rules, Code of Conduct, or
                                  our terms and conditions will be acted upon by our forum moderation team. If
                                  moderation action is required, your account will receive a warning.
                              </div>
                          </div>
                        ...
                        <?php
                          ...
                          echo "<div class='alert alert-warning'>
                                You do not have permission to post in this category. Please return to the <a href='".FULL_PATH."/index.php'>forum home</a>.
                           </div>";
                      }
                      ?>
                    </div>
