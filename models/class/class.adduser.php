    ...
    public function addUser()
    {
        ...
        if($this->status)
        {
            ...
            else
            {
                ...
                $this->user_active = 1;
                $this->success = lang("ACCOUNT_REGISTRATION_COMPLETE_TYPE2", array($this->username));
            ...
            if(!$this->mail_failure)
            {
                ...
                $stmt->bind_param("sssssis", $this->username, $this->displayname, $secure_pass, $this->clean_email, $this->activation_token, $this->user_active, $ip);
                $stmt->execute();
                ...
                addPermission($this->permisson, $inserted_id);
            }
        }
    }
}
